...
20\t14370\trs6054257\tG\tA\t29\tPASS\tNS=3;DP=14;AF=0.5;DB;H2\tGT:GQ:DP:HQ\t1|2:48:1:51,51\t3|4:48:8:51,51\t5/6:43:5:.,.
20\t17330\t.\tT\tA\t3\tq10\tNS=3;DP=11;AF=0.017\tGT:GQ:DP:HQ\t.|0:49:3:58,50\t0|1:3:5:65,3\t0/0:41:3
...
def test_vcf_parser():
    with tempfile.NamedTemporaryFile(delete=False) as tmp:
        ...
        assert numpy.array_equal(snp["gts"], [[1, 2], [3, 4], [5, 6]])
